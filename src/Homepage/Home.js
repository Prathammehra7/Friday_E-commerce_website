            ...
            <div class="main3">
                <div class="box3">
                    ...
                    <div class="container3">
                        <a href="#!" >
                            <img className=" w-52" src="https://www.notebookcheck.net/fileadmin/Notebooks/News/_nc3/iQOO_9_Series_India_Launch_MySmartPrice_1024x538.jpg" alt="" />
                        </a>
                    ...
                    <div class="container3">
                        <a href="#!" >
                            <img className=" w-52" src="https://cdn.neow.in/news/images/uploaded/2021/05/1620854220_zenfone_8_series_(5)_story.jpg" alt="" />
                        </a>

                        <div className="p-6 w-52">
                            <h2 class="text"><b>Asus Zenfone 8</b></h2>
                            <p className="pb-4">
                                Some quick example text to build on the card title and make up the bulk of the card's
                                content.
                            </p>
